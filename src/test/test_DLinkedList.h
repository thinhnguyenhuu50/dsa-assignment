/*
 * File:   test_DLinkedList.h
 */

#ifndef TEST_DLINKEDLIST_H
#define TEST_DLINKEDLIST_H
...
private:
    ...
    // Helper function for freeing DLinkedList of pointers
    static void freeIntPtrList(DLinkedList<int*>* list) {
        DLinkedList<int*>::free(list);
    }
...
public:
    ...
    static void testRemoveItemWithPointers() {
        ...
        DLinkedList<int*> list(freeIntPtrList, intPtrEqual);
    ...
    static void testIterator() {
        cout << "Testing forward iterator..." << endl;
        ...
        cout << "Forward iterator test passed!" << endl;
    }
    
    static void testBWDIterator() {
        cout << "Testing backward iterator..." << endl;
        ...
        // Test backward iterator removal
        auto it = list.bbegin();
        it--; // Move to middle element
        it.remove();
        assert(list.size() == 2);
        assert(list.get(0) == 10);
        assert(list.get(1) == 30);
        
        cout << "Backward iterator test passed!" << endl;
    }
    ...
    static void testPointerArray() {
        cout << "Testing contains array method..." << endl;
        ...
        int arr[] = {10, 20, 30};
        assert(list.contains(arr, 3));
        
        int arr2[] = {10, 20, 40};
        assert(!list.contains(arr2, 3));
        
        cout << "Contains array method test passed!" << endl;
    }
